...
/**
 * *Important: Wondering why we are usign the Icons as a seperate export component?
 * Answer to this is that considering using a plus logo everywhere in the app
 * Then we can simply import the Logo from the Icons and use it everywhere.
 * If needed to change in the future I need to change it only in one place.
 * This is the reason why we are using the Icons as a seperate export component.
 *  */
export const Icons = {
